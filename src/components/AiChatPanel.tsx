...
import { Send, Trash2, Sparkles, Loader2, ThumbsUp, ThumbsDown, Menu } from "lucide-react";
...
import { PresetQuestionsDrawer } from "@/components/PresetQuestionsDrawer";
...
export function buildQuestionSections(stocks: Stock[], regime: RegimeData): QuestionSection[] {
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full gap-3 py-8 text-center">
            ...
            <p className="text-xs text-muted-foreground">
              Tap <Menu className="inline w-3.5 h-3.5 mx-0.5" /> to browse suggested questions
            </p>
          </div>
        ) : (
          messages.map((msg, i) => (
      ...
      <div className="border-t border-border p-3">
        <div className="flex gap-2 items-center">
          ...
          <button
            ...
            className="h-9 w-9 flex items-center justify-center rounded-md border border-border text-muted-foreground hover:text-foreground hover:border-primary/40 hover:bg-primary/5 transition-colors disabled:opacity-40"
          >
        ...
        <PresetQuestionsDrawer
          sections={buildQuestionSections(stocks, regime)}
          open={drawerOpen}
